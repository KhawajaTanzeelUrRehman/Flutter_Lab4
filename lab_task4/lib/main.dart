            ...
            children: [
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      _isDecrementDisabled ? Colors.grey : Colors.green, // Change background color when disabled
                  disabledBackgroundColor: Colors.grey[300], // Dull background color when disabled
                ),
              ),
              SizedBox(width: 10),
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      _isIncrementDisabled ? Colors.grey : Colors.green, // Change background color when disabled
                  disabledBackgroundColor: Colors.grey[300], // Dull background color when disabled
                ),
              ),
            ],
